# -*- coding: utf-8 -*-
"""
Created on Wed Sep 25 13:55:59 2019
...
train_dir = 'D:/My Programs/Artificial Intelligence/semantic Analysis/'
test_dir = 'D:/My Programs/Artificial Intelligence/semantic Analysis/'
#D:/My Programs/Artificial Intelligence/semantic Analysis
glove_file = 'D:/My Programs/Artificial Intelligence/semantic Analysis/glove.6B.50d.txt'
word_embed_size = 50
batch_size = 0
epochs = 0
...
sentence_left_train,sentence_right_train,scores_train = load_data(os.path.join(train_dir,'train2.txt'))
...
sentence_left_test, sentence_right_test, scores_test = load_data(os.path.join(test_dir, 'test1.txt'))
