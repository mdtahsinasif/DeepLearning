...
news = pd.read_csv("C:/Users/tahsin.asif/OneDrive - Antuit India Private Limited/Asif/AI/UCI_NEWS/uci-news-aggregator.csv") #Importing data from CSV
...
for i in range(0,number_reviews_test):
    ...
    # Creating Bag of words for each head line
...
X_test = bagOfWords_test.toarray()
 ...
 #Using Naive Bayes for training and calculating the accuracy of the mode
